...
# data loading
train_data = dataloader.get_processed_dataset(train=True, transform=transform,
                                              target_transform=target_transform, args=args, exist=True)
val_data = dataloader.get_processed_dataset(train=False, transform=transform,
                                            target_transform=target_transform, args=args, exist=True)
...
if __name__ == '__main__':
    logger.log(main, f'./logs/{args.dataset}_{args.noise_type}_{args.noise_rate}_ce.log')

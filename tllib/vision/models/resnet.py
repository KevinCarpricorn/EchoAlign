...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        if arch == 'resnet50':
            ...
            # Add similar conditions for other architectures
            raise NotImplementedError("Pretrained weights not available for this architecture")

        pretrained_dict = load_state_dict_from_url(weights.url, progress=progress)
